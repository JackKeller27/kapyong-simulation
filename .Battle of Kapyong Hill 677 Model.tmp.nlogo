...
to update-un-tiredness
  ...
  let t0  ; midpoint where rate is highest (tiredness decreases fastest). A little under 2 hours in
...
to perform-mortar-strike
  ...
  let fire-rate calculate-fire-rate 4 (num-shots / 6) num-shots ; k min-rate max-rate
